...
export IMG=/home/philipp.gaspar/BRICS-TB/screening_backdoor-gpu.sif
...
srun -N 1 -n 1 -c $SLURM_CPUS_PER_TASK singularity exec --nv --bind $BIND_PHIL --bind $BIND_BRICS $IMG python ~/BRICS-TB/tb-brics-tools/screening/run_report.py -info report_info.json -hash TrainBaseline_989f87bed5
